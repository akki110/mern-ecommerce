...
export const ProductCard = ({ item }) => {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-lg font-bold text-text-main mb-1 truncate">{item.name}</h3>
      <p className="text-sm text-text-muted mb-4 line-clamp-2 min-h-[40px]">{item.description}</p>
